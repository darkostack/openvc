...
#if (OPENVC_CONFIG_LOG_OUTPUT == OPENVC_CONFIG_LOG_OUTPUT_DEBUG_UART) && (!OPENVC_CONFIG_DEBUG_UART_ENABLE)
#error OPENVC_CONFIG_DEBUG_UART_ENABLE_LOG requires OPENVC_CONFIG_DEBUG_UART_ENABLE
#endif
